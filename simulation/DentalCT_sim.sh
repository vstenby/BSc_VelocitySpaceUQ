...
#BSUB -o ./DentalCT_sim/Output_%J_%I.out
#BSUB -e ./DentalCT_sim/Error_%J_%I.err

# here follow the commands you want to execute
# Program_name_and_options

matlab -nodisplay -r 'DentalCT_sim($LSB_JOBINDEX)' -logfile testOut
